...
return (
    <SideBar>
        <Box>
            <SideLink to={"/"}>
                <svg stroke="currentColor" fill="black" stroke-width="0" viewBox="0 0 448 512" height="1.8em" width="1.3em" xmlns="http://www.w3.org/2000/svg"><path d="M433.941 129.941l-83.882-83.882A48 48 0 0 0 316.118 32H48C21.49 32 0 53.49 0 80v352c0 26.51 21.49 48 48 48h352c26.51 0 48-21.49 48-48V163.882a48 48 0 0 0-14.059-33.941zM224 416c-35.346 0-64-28.654-64-64 0-35.346 28.654-64 64-64s64 28.654 64 64c0 35.346-28.654 64-64 64zm96-304.52V212c0 6.627-5.373 12-12 12H76c-6.627 0-12-5.373-12-12V108c0-6.627 5.373-12 12-12h228.52c3.183 0 6.235 1.264 8.485 3.515l3.48 3.48A11.996 11.996 0 0 1 320 111.48z"></path></svg>
                Saved Bugs
            </SideLink>

            <SideLink to={"/unsaved-bugs"} id="unsaved">
                <svg stroke="currentColor" fill="black" stroke-width="0" viewBox="0 0 16 16" height="5em" width="1.6em" xmlns="http://www.w3.org/2000/svg"><path d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zM6 7.5h4a.5.5 0 0 1 0 1H6a.5.5 0 0 1 0-1z"></path></svg>
                Unsaved Entry
            </SideLink>
            ...
            <button id="logout" onClick={logout}>
                <svg stroke="currentColor" fill="black" stroke-width="0" viewBox="0 0 24 24" height="2em" width="1.5em" xmlns="http://www.w3.org/2000/svg"><path d="M16 13v-2H7V8l-5 4 5 4v-3z"></path><path d="M20 3h-9c-1.103 0-2 .897-2 2v4h2V5h9v14h-9v-4H9v4c0 1.103.897 2 2 2h9c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2z"></path></svg> 
                Logout
            </button>
        </Box>
    </SideBar>
