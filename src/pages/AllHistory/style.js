...
export const Box = styled.div`
    ...
    cursor: pointer;
    gap: 0.5em;
    color:${({ selected }) => (selected ? (props)=>props.theme.palette.primary : (props)=>props.theme.palette.text.main)};
    background-color: ${({ selected }) => (selected ? (props)=>props.theme.palette.nonPrimary : (props)=>props.theme.palette.lightYellow)};
`;
